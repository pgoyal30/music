    ...
    <body class="bg-primary">
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="<?=base_url()?>AdminController/index">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            if(nameError == "" && emailError == "" && mobileError == "" && passwordError == ""){
                $.ajax({
                    url: "<?=base_url()?>AdminController/checkemail",
                    type: "POST",
         ...
         function insert(fullName, email, mobile, password){
            console.log(fullName + " " + email + " " + mobile + " " + password);
            $.ajax({
            url: "<?=base_url()?>AdminController/insertuserinfo",
            type: "POST", 
             data: {name: fullName, email: email, mobile: mobile, password: password},
                success: function(response){
                    ...
                    if(response == "Yes"){
                        ...
                        window.location.href = "<?=base_url()?>AdminController/index";
                    }else{
