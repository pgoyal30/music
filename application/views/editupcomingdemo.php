           ...
           <main>
                    ...
                    <div class="container-fluid">
                        <h1 class="mt-3 mb-5 text-center">Edit Upcoming Product</h1>
                           ...
                           <div>
                                <form action = "<?=base_url()?>AdminController/edit_upcomingdemo/<?=$product->id?>" id = "user-info" method = "POST" enctype = "multipart/form-data">


										<div class="form-group">
                                            <label for="demotrack">Upload Demo Tracks<span class = "requried">*</span></label>
                                            <input type="file" name="demotrack[]" id="demotrack" class = "form-control" required multiple>
